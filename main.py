...
bob = input("name")
he = input(f"{bob}s first pronoun ex:he")
him = input(f"{bob}s seccond pronoun ex:him")
...
#prints a paragraph of the story
print("----------------------------------------------------")
say(f"Now that {bob} opened the {bakesale} {he} {start}ed to recive {customer}s.")
...
say("come on man one last hurah we can do it!")
#asks the user for more words
